...
public interface TweetsContainer<T extends Tweet> extends Collection<T>, Iterable<T>, Serializable {
    /**
     ...
     * @return true if this container changed as a result of the call
     */
    boolean addAll(Collection tweets);
     ...
     */
    Map<String, Long> getTagCloud(String lang);
